...
const Sidebar = () => {
  ...
  const [openSubmenus, setOpenSubmenus] = useState({
    ...
    users: location.pathname.startsWith('/admin/students') || location.pathname.startsWith('/bulk-add-students')
  });
  ...
  return (
    <div className="sidebar" style={{ position: 'sticky', top: '0', width: '270px', margin: '0', height: '100vh', display: 'flex', flexDirection: 'column', padding: '32px 20px', background: '#ffffff', borderRight: '1px solid var(--border)', zIndex: 100 }}>
      {/* Brand Logo */}
      <div className="logo" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '40px', flexShrink: 0 }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, letterSpacing: '0.75px', color: '#0f172a', textTransform: 'uppercase', margin: 0 }}>Squire</h2>
      </div>
