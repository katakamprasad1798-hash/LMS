...
import { Plus, Image as ImageIcon, Type, User, DollarSign, Clock, BookOpen, ShieldCheck, X, Video, FileText, HelpCircle, ChevronRight, ChevronLeft } from 'lucide-react';
          ...
          {step === 1 && (
            <motion.div key="step1" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                ...
                <InputGroup label="Price ($)" name="price" icon={<DollarSign size={18} />} placeholder="e.g. 49.99" value={formData.price} onChange={handleChange} />
