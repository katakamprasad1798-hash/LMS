...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar glass" style={{ position: 'sticky', top: '24px', width: '260px', margin: '24px', height: 'calc(100vh - 48px)', display: 'flex', flexDirection: 'column', padding: '24px' }}>
      ...
      <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '8px', overflowY: 'auto', paddingRight: '8px', minHeight: 0 }}>
        {userRole === 'student' && (
          <>
      ...
      <div className="logout" style={{ marginTop: 'auto', flexShrink: 0, paddingTop: '16px' }}>
        <button 
          ...
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: 'pointer' }}
        >
